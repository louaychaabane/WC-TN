...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="hero overlay" style="background-image: url('images/bg1.jpg');">
      <div class="container">
          ...
          <div class="col-lg-4 ml-auto">
            ...
            <ul class="list-unstyled">
              <li class="mb-2">
                ...
                ISSATSO <br> Rue Taher Ben Achour Sousse
              </li>
              <li class="mb-2">
                <strong class="text-white d-block">Email</strong>
                <a href="#">Ahmedghliss@ieee.org <br> louaychaabane00@gmail.com</a>
              </li>
              <li class="mb-2">
                <strong class="text-white d-block">
                  Phone
                </strong>
                <a href="#">+216 29456877<br>+216 50412250 </a>
              </li>
            </ul>
          </div>
        </div>
