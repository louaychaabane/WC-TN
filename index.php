...
<head>
  <title>World Cup &mdash; Tunisia</title>
  <meta charset="utf-8">
...
<div class="container">
  <div class="d-flex align-items-center">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-5 ml-auto">
            <h1 style="text-shadow: 2px 2px 4px black" class="text-white">World Cup Event</h1>
            <p style="text-shadow: 2px 2px 2px black">Tunisia has participated five times in the FIFA World Cup, the biggest men's football event in the world in 1978, 1998, 2002, 2006 and 2018. They will make their sixth appearance at the finals in the 2022 FIFA World Cup in Qatar.</p>
            
            <p>
              <a href="tickets.php" class="btn btn-primary py-3 px-4 mr-3">Book Ticket</a>
    ...
    <a href="https://youtu.be/lT6epp9BdvQ"  data-fancybox>
    <div class="container">
            ...
            <div class="team-1 w-50">
              <div class="team-details w-100 text-center">
                ...
                <ul class="list-unstyled">
                  <li>Wahbi Khazri 58'</li> <!-- 7el bountou -->
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <a href="#">
                <img src="<?php echo $Best["img"]; ?>" alt="Image" class="img-fluid">
              </a>
              <div class="caption">
                <div class="caption-inner">
                  <h3 STYLE="font-size:30px" class="mb-3"><?php echo $Best["name"]; ?></h3>
                  <div class="author d-flex align-items-center">
                    <div class="img mb-2 mr-3">
                      <h4 STYLE="font-size:45px"><?php echo $Best["Rating"]; ?><span style="font-size:15px"></span></h4>
                    </div>
                    <div class="text">
                      
                    <span STYLE="font-size:18px">Tunisia &bullet; <?php echo $Best["age"]; ?> Years Old</span>
                    </div>
                  </div>
                </div>
              </div> 
            ...
            <div class="widget-next-match">
              <table class="table custom-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo $i ?></td>
                    <td><strong class="text-white"><?php echo $team["name"]; ?></strong></td>
            ...
            <div class="widget-next-match">
              <table class="table custom-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo $i ?></td>
                    <td><strong class="text-white"><?php echo $scorer["name"]; ?></strong></td>
                    <td><?php echo $scorer["nationality"]; ?></td>
